...
function bindSourceAdTypeLink(row){
  ...
  sourceSel.addEventListener("change", ()=>{
    setAdListBySource(sourceSel.value, false);
  });
...
async function addRow(){
  try{
    ...
    const body = {
      ...
      operator: "",
      source: "广告",
      ad_type: AD_TYPES_AD[0],   // ✅ 广告默认用广告类型
      user_mark: "",             // ✅ 号码/标识保留
      service: "",
      valid: "有效",
      deal: "否",
